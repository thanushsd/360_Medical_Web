...
?>
  ...
  text: 'Welcome <?php echo $title ?><?php echo $fname ?> <?php echo $lname ?> ',
			...
			<div class="container-fluid">
				<div class="form-head d-flex align-items-center mb-sm-4 mb-3">
					<div class="mr-auto">
						...
						<p class="mb-0">360<sup>0</sup> Medical Admin Dashboard </p>
					</div>
...
?>
										<h2 class="fs-34 text-black font-w600">0<?php echo $x ?></h2>
							...
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										<?php
										$y=0;
	$sql=" SELECT * FROM admit WHERE status=0 ";
	$result=$conn->query($sql);
	while($row=$result->fetch_assoc())
	{
	$y=$y+1;}
...
?>
										<h2 class="fs-34 text-black font-w600">0<?php echo $y ?></h2>
...
?>
										<h2 class="fs-34 text-black font-w600">0<?php echo $d ?></h2>
									...
									<div class="card-body">
										<div class="row">
											...
											<div class="col-xl-6 col-xxl-12  col-md-6 height415 dz-scroll" id="appointment-schedule">
												<?php
	$sql=" SELECT * FROM appoinment LIMIT 3";
	$result=$conn->query($sql);
	while($row=$result->fetch_assoc())
	{
	...
	?>
												<div class="d-flex pb-3 border-bottom mb-3 align-items-end">
													<div class="mr-auto">
														<p class="text-black font-w600 mb-2"><?php echo $date ?></p>
														<ul>
															<li><i class="las la-clock"></i><?php echo $time ?></li>
															<li><i class="las la-user"></i><?php echo $pname ?></li>
														</ul>
													</div>
...
<?php
	...
	?>													<tr>
														<td>
															<div class="d-flex">
																<img src="../images/male.png" alt="" class="img-2 mr-3">
																<div>
																	<h6 class="fs-16 mb-1"><a href="patient.html" class="text-black"><?php echo $pname ?></a></h6>
																	<span class="fs-14"><?php echo $pname ?></span>
																</div>
															</div>
														</td>
														<td>
															<div>
																<p class="fs-14 mb-1">Contact</p>
																<span class="text-primary font-w600 mb-auto"><?php echo $ptel ?></span>
															</div>
														</td>
														<td>
															<div>
																<p class="fs-14 mb-1">Status</p>
																<span class="text-primary font-w600 mb-2 d-block text-nowrap"><?php echo $st ?></span>
