	...
	<div id="main-wrapper" >
		...
		<div class="col-xl-12 col-lg-12">
                ...
                <input type="hidden" name="apptime" value="<?php echo $apptime ?>">
                                        ...
                                        <div class="input-group mb-3 input-primary">
                                            <input type="text" name="pname" class="form-control" placeholder="Patient's Name">
                                        </div>
                                        <div class="input-group mb-3 input-primary">
                                            <input type="text" name="page" class="form-control" placeholder="Patient's Age">
                                        </div>
                                        <div class="input-group mb-3 input-primary">
                                            <input type="text" name="pnic" class="form-control" placeholder="Patient's NIC">
                                        </div>
                                        <div class="input-group mb-3 input-primary">
                                        ...
                                        <div class="input-group mb-3 input-primary">
                                            <input name="pemail" type="text" class="form-control" placeholder="Patient's E-mail Address">
                                            <div class="input-group-append">
                                                <span class="input-group-text">@gmail.com</span>
                                            </div>
                                        </div>
                                        <div class="input-group mb-3 input-primary">
                                            <input type="text" name="ptel" class="form-control" placeholder="Patient's Phone No">
                                        </div>
                                        <div class="input-group mb-3 input-primary">
