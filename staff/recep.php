...
<div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-sm-4 mb-3">
					<div class="mr-auto">
						<h2 class="text-black font-w600">Receptionists</h2>
						<p class="mb-0">Registered Receptionists</p>
					</div>
					<div>
						<a href="addR.php" class="btn btn-primary mr-3" >+ New Receptionist</a>
	...
	<?php
	$sql=" SELECT * FROM staff WHERE position=4 ";
