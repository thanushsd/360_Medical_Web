		...
		<div class="col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add Head Nurse</h4>
                            </div>
                            <div class="card-body">
        ...
        <div class="avatar-preview">
            <div id="imagePreview" style="background-image: url(../images/users/user.png);">
                                        ...
                                        <div style=" border: solid; border-color: #007a64; border-width: 1px; " class="mb-3 p-2 input-primary">
                                            ...
                                            <input value="Mr" name="title" type="radio"> Mr.
                                            <input value="Mrs" class="ml-5" name="title" type="radio"> Mrs.
                                            <input value="Miss" class="ml-5" name="title" type="radio"> Miss
                                        </div>
                                        ...
                                        <div class="input-group mb-3 input-primary">
                                            <input required type="number" maxlength="3" name="age" class="form-control" placeholder="Age">
                                        </div>
                                        <div style=" border: solid; border-color: #007a64; border-width: 1px; " class="mb-3 p-2 input-primary">
                                        ...
                                        <div class="input-group mb-3 input-primary">
                                            <input type="text" name="pw" class="form-control" placeholder="Create Password">
                                        </div>
                                        <input value="2" type="hidden" name="position">
