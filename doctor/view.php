				...
				<div class="form-head d-flex page-titles mb-sm-4 mb-3 align-items-center">
					<div class="mr-auto">
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="javascript:void(0)">#D-000<?php echo $docid ?></a></li>
						</ol>
					</div>
						...
						<div class="row">
							<div class="col-xl-12">
								<div class="card doctor-details-card">
									<div class="bg-img-bx">
										<img src="../images/coverdoc.png" alt="" class="bg-img">
										<a href="" class="btn btn-primary"><i class="las la-stethoscope mr-3 scale5"></i><?php echo $spec ?></a>
									</div>
									<div class="card-body">
										<div class="d-sm-flex d-block mb-3">
											...
											<div class="card-info d-flex align-items-start">
												<div class="mr-auto pr-3">
													<h2 class="font-w600 mb-sm-2 mb-1 text-black">Dr. <?php echo $name ?></h2>
													<p class="mb-sm-2 mb-1">#D-000<?PHP echo $docid; ?></p>
													<span class="date">
													<i class="las la-clock"></i>
													Join on <?php echo $date ?></span>
												</div>
